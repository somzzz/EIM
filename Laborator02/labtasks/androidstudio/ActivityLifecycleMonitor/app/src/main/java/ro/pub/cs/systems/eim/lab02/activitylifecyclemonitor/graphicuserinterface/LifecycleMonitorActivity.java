...
public class LifecycleMonitorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            Log.d("activitylifecycle", "onCreate() method was invoked with prev instance");
        } else {
            Log.d("activitylifecycle", "onCreate() method was invoked");
        }
    }
    ...
    protected void onStart() {
        ...
        Log.println(Log.DEBUG, "activitylifecycle", "OnStart Bitch!");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.println(Log.DEBUG, "activitylifecycle", "OnResume Bitch!");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.println(Log.DEBUG, "activitylifecycle", "OnPause Bitch!");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.println(Log.DEBUG, "activitylifecycle", "OnStop Bitch!");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.println(Log.DEBUG, "activitylifecycle", "OnDestroy Bitch!");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.println(Log.DEBUG, "activitylifecycle", "OnRestart Bitch!");
    }
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        Log.println(Log.DEBUG, "actvitylifecycle", "save insatnce");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        Log.println(Log.DEBUG, "activitylifecycle", "restoring");
        EditText usernameEditText = (EditText)findViewById(R.id.username_edit_text);
        EditText passwordEditText = (EditText)findViewById(R.id.password_edit_text);
        CheckBox check = (CheckBox)findViewById(R.id.remember_me_checkbox);
